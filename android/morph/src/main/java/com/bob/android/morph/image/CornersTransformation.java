...
public class CornersTransformation extends BitmapTransformation {
    ...
    public CornersTransformation(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public CornersTransformation(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    public boolean equals(Object o) {
        return o instanceof CornersTransformation &&
                ((CornersTransformation) o).radius == radius &&
                ((CornersTransformation) o).diameter == diameter &&
                ((CornersTransformation) o).margin == margin &&
                ((CornersTransformation) o).cornerType == cornerType;
    }
