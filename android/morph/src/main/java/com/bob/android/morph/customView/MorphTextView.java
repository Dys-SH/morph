 ...
 */
public class MorphTextView extends AppCompatTextView implements IMorphView {
    ...
    public MorphTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MorphTextView(Context context, AttributeSet attrs, int defStyleAttr) {
